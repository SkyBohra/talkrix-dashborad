...
export default function LoginPage() {
    ...
    return (
        <div>
            <h2 style={{ color: '#6366f1', fontSize: '16px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.1em', textAlign: 'center', marginBottom: '32px' }}>
                User Login
            </h2>
            <form onSubmit={handleLogin}>
                <div style={{ position: 'relative', marginBottom: '18px' }}>
                    <User style={{ position: 'absolute', left: '18px', top: '50%', transform: 'translateY(-50%)', width: '20px', height: '20px', color: '#a5b4fc' }} />
                    <Input 
                        type="email" 
                        value={email} 
                ...
                <div style={{ position: 'relative', marginBottom: '18px' }}>
                    <Lock style={{ position: 'absolute', left: '18px', top: '50%', transform: 'translateY(-50%)', width: '20px', height: '20px', color: '#a5b4fc' }} />
                    <Input 
                        type="password" 
                        value={password} 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '28px' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
                        <div onClick={() => setRememberMe(!rememberMe)} style={{ 
                            ...
                            height: '18px', 
                            borderRadius: '50%', 
                            border: rememberMe ? 'none' : '2px solid #a5b4fc', 
                ...
                <p style={{ textAlign: 'center', marginTop: '28px', fontSize: '13px', color: '#6b7280' }}>
                    Don't have an account? <Link href="/signup" style={{ color: '#6366f1', fontWeight: 600 }}>Sign up</Link>
                </p>
            </form>
        </div>
    );
